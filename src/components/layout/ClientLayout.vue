<template>
  <div class="layout">
    <header class="top-nav">
      <div class="nav-inner">
        <router-link class="brand" to="/client">法医咨询者</router-link>
        <nav class="nav-links">
          <router-link to="/client">咨询中心</router-link>
          <router-link to="/client/check">初步检测</router-link>
          <router-link to="/client/consult">咨询服务</router-link>
